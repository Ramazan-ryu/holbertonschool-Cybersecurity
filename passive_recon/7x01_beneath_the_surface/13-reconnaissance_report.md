...
* **UDP Blind Spot:** Scans were restricted to TCP Connect (`-sT`). UDP services remain unenumerated.
* **Rate Limiting:** Aggressive WAF tarpitting may have caused false negatives during brute-force tasks.
* **Exploitation Limits:** High-severity CVEs were identified via software banners only. Without active exploitation, we cannot confirm if backported patches mitigate the vulnerabilities.

## Appendix script-to-flag index
* Task 1: 1-nameserver.sh
* Task 2: 2-hidden_subdomain.sh
* Task 3: 3-asn.sh
* Task 4: 4-admin_port.sh
* Task 5: 5-portal_version.sh
* Task 6: 6-san_entry.sh
* Task 7: 7-admin_path.sh
* Task 8: 8-dmarc.sh
* Task 9: 9-waf.sh
* Task 10: 10-bucket.sh
* Task 11: 11-undoc_endpoint.sh
* Task 12: 12-cve.sh
