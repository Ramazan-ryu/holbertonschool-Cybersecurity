...
| Asset | Service Type | Version | Notes |
| :--- | :--- | :--- | :--- |
| `portal.astralis-cloud.example` | Web Gateway | `nginx/1.0.0` | Version extracted via HTTP headers |
| `portal.astralis-cloud.example` | WAF / CDN | `ExampleWAF` | Provider identified via header signatures |
| `admin.astralis-cloud.example` | Admin Service | `Unknown` | TCP Port > 49152 |
| `*.s3.amazonaws.com` | Object Storage | `Unknown` (AWS S3) | Verified via HTTP 403 status |
...
## Appendix A: Script-to-flag index
