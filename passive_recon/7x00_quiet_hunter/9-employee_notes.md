# Employee Notes — Task 9

## Finding 1: Senior IT or security lead
- Name: Joris Bakker
- Corporate email: joris.bakker@helix-maritime.example
- Sources cross-referenced:
  * Lattice professional profile explicitly identifying him as "Infrastructure & Security Lead".
  * Public humans.txt file confirming "Joris Bakker" under the Infrastructure & Security section.
  * Corporate email pattern (first.last@helix-maritime.example) triangulated from the public GitHub commit metadata of other developers.

## Finding 2: Helix developer with public repository
- Username: dvries
- Identification: Daan de Vries, Backend Developer
- Repository: helix-maritime/tidewater-engine
