...
*   **Gap 1: Ambiguous Out-of-Scope Definitions.** In my Day 1 draft, while I explicitly excluded the medical devices, I did not firmly establish that *anything not explicitly listed in the 'In-Scope' section is automatically out of scope*. I relied on a "tentative" list. *Why it matters:* As seen in "The Scope Creep" case, relying on assumptions rather than a strict whitelist/blacklist approach leads to accidental exploitation of third-party or sensitive internal assets.
*   **Gap 2: Lack of an Engagement Risk Register.** I listed "Red Flags," but I did not systematically evaluate the risks to the *engagement itself* (e.g., likelihood of downtime, project delays). *Why it matters:* Penetration testing is a consulting engagement. Failing to manage operational risks means Vanguard could be held responsible for business interruptions, even if we were technically sound.
*   **Gap 3: No Operational Hard Gate (Go/No-Go).** I mentioned needing signatures, but I did not formulate it as a strict operational checklist required before testing commences. *Why it matters:* Without a Go/No-Go checklist, consultants might start reconnaissance or setup tasks while "waiting for the paperwork," which still constitutes unauthorized access under laws like the CFAA.
